...
from segmentalist.gaussian_components_fixedvar import (
...
def test_log_prod_norm():
    ...
    gmm = GaussianComponentsFixedVar(np.array([x]), prior, K_max=x.shape[0])
...
def test_log_marg_k():
    ...
    gmm = GaussianComponentsFixedVar(X_1, prior, assignments=assignments, K_max=X_1.shape[0])
